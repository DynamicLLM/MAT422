---
name: mat422-section-3-4-logistic-regression
description: Create MAT 422 Section 3.4 Python/Jupyter Notebook homework demonstrations for logistic regression, sigmoid probabilities, model fitting, and decision boundaries. Use when a student or instructor asks for a Colab-ready notebook, sample homework, explanatory Python examples, rubric-aligned guidance, or a reusable assignment template for Section 3.4: Logistic Regression.
---

# MAT 422 - Section 3.4: Logistic Regression Homework

## Purpose

Use this skill to create a student-facing Jupyter Notebook for Section 3.4: Logistic Regression. The notebook should demonstrate the requested math concepts with Python code, short explanations, appropriate examples, rubric-aligned formatting, and a visible working Colab badge suitable for a public GitHub homework record.

## Core Workflow

1. Read eferences/section-3-4-guidance.md and eferences/homework-rubric.md before drafting content.
2. Create or revise a Colab-friendly .ipynb notebook. Prefer running scripts/create_section_3_4_notebook.py as a starting point, then customize examples if the user gives preferences.
...
`powershell
python scripts/create_section_3_4_notebook.py --output assets/MAT422_Section_3_4_Logistic_Regression.ipynb
`
