---
name: mat422-section-3-5-3-6-kmeans-svm
description: Create MAT 422 Sections 3.5 and 3.6 Python/Jupyter Notebook homework demonstrations for K-means clustering and support vector machines. Use when a student or instructor asks for a Colab-ready notebook, sample homework, explanatory Python examples, rubric-aligned guidance, or a reusable assignment template for Sections 3.5 and 3.6: K-means and Support Vector Machines.
---

# MAT 422 - Sections 3.5 and 3.6: K-means and Support Vector Machines Homework

## Purpose

Use this skill to create a student-facing Jupyter Notebook for Sections 3.5 and 3.6: K-means and Support Vector Machines. The notebook should demonstrate the requested math concepts with Python code, short explanations, appropriate examples, rubric-aligned formatting, and a visible working Colab badge suitable for a public GitHub homework record.

## Core Workflow

1. Read eferences/section-3-5-3-6-guidance.md and eferences/homework-rubric.md before drafting content.
2. Create or revise a Colab-friendly .ipynb notebook. Prefer running scripts/create_section_3_5_3_6_notebook.py as a starting point, then customize examples if the user gives preferences.
...
`powershell
python scripts/create_section_3_5_3_6_notebook.py --output assets/MAT422_Section_3_5_3_6_KMeans_SVM.ipynb
`
