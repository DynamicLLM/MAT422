---
name: mat422-section-2-4-mle-linear-regression
description: Create MAT 422 Section 2.4 Python/Jupyter Notebook homework demonstrations for maximum likelihood estimation for random samples and linear regression. Use when a student or instructor asks for a Colab-ready notebook, sample homework, explanatory Python examples, rubric-aligned guidance, or a reusable assignment template for Section 2.4: MLE and Linear Regression.
---

# MAT 422 - Section 2.4: MLE and Linear Regression Homework

## Purpose

Use this skill to create a student-facing Jupyter Notebook for Section 2.4: MLE and Linear Regression. The notebook should demonstrate the requested math concepts with Python code, short explanations, appropriate examples, rubric-aligned formatting, and a visible working Colab badge suitable for a public GitHub homework record.

## Core Workflow

1. Read eferences/section-2-4-guidance.md and eferences/homework-rubric.md before drafting content.
2. Create or revise a Colab-friendly .ipynb notebook. Prefer running scripts/create_section_2_4_notebook.py as a starting point, then customize examples if the user gives preferences.
...
`powershell
python scripts/create_section_2_4_notebook.py --output assets/MAT422_Section_2_4_MLE_Linear_Regression.ipynb
`
