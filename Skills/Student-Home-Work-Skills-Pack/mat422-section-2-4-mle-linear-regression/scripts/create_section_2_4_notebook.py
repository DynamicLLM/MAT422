#!/usr/bin/env python3
"""Generate a MAT 422 - Section 2.4: MLE and Linear Regression starter Jupyter Notebook."""
...
def build_notebook() -> dict:
    return {
        ...
        "metadata": {
            ...
            "colab": {"name": "MAT422_Section_2_4_MLE_Linear_Regression.ipynb"},
        },
        "nbformat": 4,
        "nbformat_minor": 5,
    }
...
def main() -> None:
    ...
    parser.add_argument("--output", default="MAT422_Section_2_4_MLE_Linear_Regression.ipynb", help="Output notebook path")
