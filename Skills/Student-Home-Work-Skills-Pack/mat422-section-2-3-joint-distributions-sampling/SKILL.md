---
name: mat422-section-2-3-joint-distributions-sampling
description: Create MAT 422 Section 2.3 Python/Jupyter Notebook homework demonstrations for joint probability distributions, correlation and dependence, and random samples. Use when a student or instructor asks for a Colab-ready notebook, sample homework, explanatory Python examples, rubric-aligned guidance, or a reusable assignment template for Section 2.3: Joint Distributions, Dependence, and Sampling.
---

# MAT 422 - Section 2.3: Joint Distributions, Dependence, and Sampling Homework

## Purpose

Use this skill to create a student-facing Jupyter Notebook for Section 2.3: Joint Distributions, Dependence, and Sampling. The notebook should demonstrate the requested math concepts with Python code, short explanations, appropriate examples, rubric-aligned formatting, and a visible working Colab badge suitable for a public GitHub homework record.

## Core Workflow

1. Read eferences/section-2-3-guidance.md and eferences/homework-rubric.md before drafting content.
2. Create or revise a Colab-friendly .ipynb notebook. Prefer running scripts/create_section_2_3_notebook.py as a starting point, then customize examples if the user gives preferences.
...
`powershell
python scripts/create_section_2_3_notebook.py --output assets/MAT422_Section_2_3_Joint_Distributions_Sampling.ipynb
`
