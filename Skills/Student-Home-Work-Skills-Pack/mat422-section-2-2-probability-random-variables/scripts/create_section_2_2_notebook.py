#!/usr/bin/env python3
"""Generate a MAT 422 - Section 2.2: Probability and Random Variables starter Jupyter Notebook."""
...
CELLS_JSON = r'''[
    {
        "source":  [
                       "[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DynamicLLM/MAT422/blob/main/Skills/Student-Home-Work-Skills-Pack/mat422-section-2-2-probability-random-variables/assets/MAT422_Section_2_2_Probability_Random_Variables.ipynb)\\\\n",
                       "\\\\n",
...
def build_notebook() -> dict:
    return {
        ...
        "metadata": {
            ...
            "colab": {"name": "MAT422_Section_2_2_Probability_Random_Variables.ipynb"},
        },
        "nbformat": 4,
        "nbformat_minor": 5,
    }
...
def main() -> None:
    ...
    parser.add_argument("--output", default="MAT422_Section_2_2_Probability_Random_Variables.ipynb", help="Output notebook path")
