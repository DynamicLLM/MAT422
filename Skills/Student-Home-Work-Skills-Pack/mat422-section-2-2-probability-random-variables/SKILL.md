---
name: mat422-section-2-2-probability-random-variables
description: Create MAT 422 Section 2.2 Python/Jupyter Notebook homework demonstrations for probability axioms, conditional probability, discrete random variables, and continuous random variables. Use when a student or instructor asks for a Colab-ready notebook, sample homework, explanatory Python examples, rubric-aligned guidance, or a reusable assignment template for Section 2.2: Probability and Random Variables.
---

# MAT 422 - Section 2.2: Probability and Random Variables Homework

## Purpose

Use this skill to create a student-facing Jupyter Notebook for Section 2.2: Probability and Random Variables. The notebook should demonstrate the requested math concepts with Python code, short explanations, appropriate examples, rubric-aligned formatting, and a visible working Colab badge suitable for a public GitHub homework record.

## Core Workflow

1. Read eferences/section-2-2-guidance.md and eferences/homework-rubric.md before drafting content.
2. Create or revise a Colab-friendly .ipynb notebook. Prefer running scripts/create_section_2_2_notebook.py as a starting point, then customize examples if the user gives preferences.
...
`powershell
python scripts/create_section_2_2_notebook.py --output assets/MAT422_Section_2_2_Probability_Random_Variables.ipynb
`
